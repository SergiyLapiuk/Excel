...
public interface ILabCalculatorListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterUnaryAdditiveExpr([NotNull] LabCalculatorParser.UnaryAdditiveExprContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>UnaryAdditiveExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitUnaryAdditiveExpr([NotNull] LabCalculatorParser.UnaryAdditiveExprContext context);
