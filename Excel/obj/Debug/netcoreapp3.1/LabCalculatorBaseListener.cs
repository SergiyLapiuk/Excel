...
public partial class LabCalculatorBaseListener : ILabCalculatorListener {
	...
	/// <summary>
	/// Enter a parse tree produced by the <c>UnaryAdditiveExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterUnaryAdditiveExpr([NotNull] LabCalculatorParser.UnaryAdditiveExprContext context) { }
	/// <summary>
	/// Exit a parse tree produced by the <c>UnaryAdditiveExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitUnaryAdditiveExpr([NotNull] LabCalculatorParser.UnaryAdditiveExprContext context) { }
