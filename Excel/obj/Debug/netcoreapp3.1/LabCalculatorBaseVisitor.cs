...
public partial class LabCalculatorBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ILabCalculatorVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by the <c>UnaryAdditiveExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitUnaryAdditiveExpr([NotNull] LabCalculatorParser.UnaryAdditiveExprContext context) { return VisitChildren(context); }
